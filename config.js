...
global.sudo = process.env.SUDO || '201128698632'
global.devs = '201128698632';
global.website = 'https://chat.whatsapp.com/HzfsFIfYTj7HdjbekZPfIT' //wa.me/+25000000000000
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? '𝑨𝑵𝑮𝑬𝑳𝑶✨🌑' : process.env.OWNER_NAME,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '𝑨𝑵𝑮𝑬𝑳𝑶✨🌑' : process.env.PACK_INFO.split(";")[1],
